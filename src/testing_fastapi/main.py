...
@app.post("/list_of_things/{item_id}", status_code=status.HTTP_201_CREATED, response_model=List[dict], description="Get a list of items")
async def get_a_list_of_items():
    return [
        {
            "username": "random user_username",
            "data": [
                "user data here"
            ]
        }
